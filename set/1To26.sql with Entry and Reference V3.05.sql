...
FROM
	(
		...
		from
			...
			left join [PCLAWDB_32130].[dbo].GBComm Comm on Alloc.GBankAllocInfCheckID = Comm.GBankCommInfID
			--9
		union
...
where
	EntryNumber In(1934580) --and T.GLDate BETWEEN 20240101 AND 20240131-- T.GLDate BETWEEN 20240101 AND 20240131 AND T.ReferenceNumber IN ('23133094', '23132901', '23132048', '12/05/23')
