...
FROM
    (
        ...
        from
            ...
            join [PCLAWDB_32130].[dbo].TranIDX x on j.GJEntryID = x.TranIndexSequenceID --where x.TranIndexStatus = 0
            --2
        union
        ...
        from
            ...
            join [PCLAWDB_32130].[dbo].GBAlloc Alloc on Alloc.GBankAllocInfCheckID = Comm.GBankCommInfID
            join [PCLAWDB_32130].[dbo].GLAcct a on I.GBankAcctInfGLAccountID = a.GLAcctID --where GBankCommInfStatus = 0 and GBankCommInfEntryType >1200 and GBankCommInfEntryType <1500 
            --3
        union
        ...
        from
            ...
            join [PCLAWDB_32130].[dbo].GBComm Comm on Alloc.GBankAllocInfCheckID = Comm.GBankCommInfID --where  GBankCommInfStatus = 0 
        ...
        from
            ...
            left join [PCLAWDB_32130].[dbo].TranIDX t on Alloc.GBankAllocInfAllocID = t.TranIndexSequenceID --where TranIndexStatus = 0 --and t.MatterID <> 0
        ...
        Select
            ...
            Case
                when TBankCommInfEntryType in (2050, 2054) then convert(money, TBankAllocInfoAmount)
                else convert(money, 0.00)
            end as DebitAmount,
            Case
        ...
        from
            ...
            join [PCLAWDB_32130].[dbo].TBAlloc Alloc on Alloc.TBankAllocInfoCheckID = Comm.TBankCommInfSequenceID --where TBankCommInfStatus = 0 and TBankCommInfEntryType not in (1552, 1553, 2501) -- not sure why this item is excluded from the reports
            --7
        union
        ...
        from
            ...
            join [PCLAWDB_32130].[dbo].TBComm Comm on Alloc.TBankAllocInfoCheckID = Comm.TBankCommInfSequenceID --where TBankAllocInfoStatus = 0 and TBankCommInfEntryType not in (1552, 1553, 2501) -- not sure why this item is excluded from the reports
            --8
        union
        all -- AP Details
        Select
            ...
            comm.GBankCommInfPaidTo as GBankCommInfPaidTo,
        ...
        from
            ...
            join [PCLAWDB_32130].[dbo].GLAcct a on Alloc.GBankAllocInfGLID = a.GLAcctID -- left join [PCLAWDB_32130].[dbo].ActCode C on Alloc.GBankAllocInfActivityID = C.ActivityCodesID
            -- left join [PCLAWDB_32130].[dbo].MattInf m on Alloc.MatterID = m.MatterID --where APInvoiceStatus = 0 --and I.APInvoiceTotBasePST <> 0
            left join [PCLAWDB_32130].[dbo].GBComm Comm on Alloc.GBankAllocInfCheckID = Comm.GBankCommInfID --9
        union
        ...
        Select
            ...
            I.APInvoiceInvNumr as ReferenceNumber,
            I.APInvoiceID as EntryNumber --seelect SUM(GBankAllocInfAmount)
        from
            [PCLAWDB_32130].[dbo].APInv I
            join [PCLAWDB_32130].[dbo].GBAlloc Alloc on I.APInvoiceID = Alloc.GBankAllocInfCheckID
            ...
            left join [PCLAWDB_32130].[dbo].MattInf m on Alloc.MatterID = m.MatterID --where APInvoiceStatus = 0
            --10
        union
        ...
        from
            ...
            join [PCLAWDB_32130].[dbo].GBAlloc Alloc on I.APInvoiceID = Alloc.GBankAllocInfCheckID
            join [PCLAWDB_32130].[dbo].GLAcct a on Alloc.GBankAllocInfGLID = a.GLAcctID -- left join [PCLAWDB_32130].[dbo].ActCode C on Alloc.GBankAllocInfActivityID = C.ActivityCodesID
            -- left join [PCLAWDB_32130].[dbo].MattInf m on Alloc.MatterID = m.MatterID --where APInvoiceStatus = 0 and m.MatterID <> 0
            LEFT join [PCLAWDB_32130].[dbo].GBComm Comm on Alloc.GBankAllocInfCheckID = Comm.GBankCommInfID --11
        union
...
where
    EntryNumber In(1949416) --and	T.GLDate BETWEEN 20240101 AND 20240131
