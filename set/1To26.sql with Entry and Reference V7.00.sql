...
SELECT
    * --T.GLAccountAcctName, SUM(DebitAmount), SUM(CreditAmount), SUM(DebitAmount)-SUM(CreditAmount) AS TB_amount
FROM
    (
        select
            '1' as Sno,
...
where
    ...
    AND T.GLDate BETWEEN 20240601
    AND 20240630 --and T.Journal != 'GB'
