    ...
    (
        ...
        SELECT
            ...
            CASE
                ...
                AND Comm.GBankCommInfAmount >= 0 THEN CAST(Comm.GBankCommInfAmount AS NUMBER)
                WHEN Comm.GBankCommInfEntryType NOT IN (1300, 1301, 1303)
                AND Comm.GBankCommInfAmount < 0 THEN CAST(ABS(Comm.GBankCommInfAmount) AS NUMBER)
                ELSE CAST(0 AS NUMBER)
            END AS DebitAmount,
            CASE
                WHEN Comm.GBankCommInfEntryType NOT IN (1300, 1301, 1303)
        ...
        WHERE
            ...
            AND Comm.GBankCommInfEntryType BETWEEN 1201
            AND 1499
        union
        all
        SELECT
        ...
        SELECT
            ...
            CASE
                ...
                WHEN TBankCommInfEntryType = 2050
                AND TBankAllocInfoAmount < 0 THEN CAST(0 AS NUMBER)
